    ...
    return ( function () {
    ...
    } )()(
        {
            ...
            "2": [
                function ( require, module, exports ) {
                    ...
                    function getJsName ( name ) {
                        return name.replaceAll( "-", "_" ).replaceAll( "/", "_fs_" ).replaceAll( "\\", "_bs_" );
                    }
                        ...
                        _createClass( Output, [
                            ...
                            },
                            {
                                ...
                                "value": function unindent () {
                                    this.indentation = this.indentation.slice( this.indentstr.length );
                                },
                            },
                            {
                                "key": "addln",
            ...
            "5": [
                                ...
                                "value": function compile ( code ) {
                                    ...
                                    this.fn = function ( rt, overrides, dyn ) {
                                        ...
                                        try {
                                            ...
                                            Fashion.raiseAt( e.message || e, null, runtime.getCallStack() );
                                        }
                ...
                { "./Base.js": 3, "./type/Bool.js": 8, "./type/Color.js": 9, "./type/ColorRGBA.js": 11, "./type/List.js": 15, "./type/Literal.js": 16, "./type/Statics.js": 22, "./type/Text.js": 23, "./type/Type.js": 24, "./type/TypeVisitor.js": 25, "./type/Types.js": 26 },
            ],
            "6": [
                function ( require, module, exports ) {
                    "use strict";
                ...
                { "../Base.js": 3, "../Runtime.js": 5, "../parse/ValueParser.js": 7, "../type/SourceBuilder.js": 21 },
            ],
            "7": [
                function ( require, module, exports ) {
                    "use strict";
                            ...
                            },
                            {
                                ...
                                "value": function parseValue ( token ) {
                                    ...
                                    if ( ( match = rx.number.exec( token ) ) ) {
                                        return new Numeric( Number.parseFloat( match[ 1 ] ), match[ 2 ] );
                                    }
                ...
                { "../Base.js": 3, "../type/Statics.js": 22, "../type/Type.js": 24, "../type/Types.js": 26 },
            ],
            "8": [
                function ( require, module, exports ) {
            ...
            "9": [
                ...
                { "../Base.js": 3, "./Bool.js": 8, "./Numeric.js": 18, "./Type.js": 24 },
            ],
            "10": [
                function ( require, module, exports ) {
                ...
                { "../Base.js": 3, "./Color.js": 9, "./ColorRGBA.js": 11 },
            ],
            "11": [
                function ( require, module, exports ) {
                            ...
                            [
                                {
                                    ...
                                    "value": function fromHex ( value ) {
                                        ...
                                        if ( value.length === 3 ) {
                                            r = Number.parseInt( value.charAt( 0 ), 16 );
                                            g = Number.parseInt( value.charAt( 1 ), 16 );
                                            b = Number.parseInt( value.charAt( 2 ), 16 );
                            ...
                            colorChars.forEach( function ( short2 ) {
                                ...
                                colorChars.forEach( function ( short3 ) {
                                    ...
                                    if ( shortMap[ longName ] ) {
                                        ...
                                        shortName = curr.length > shortName.length
                                            ? shortName
                                            : curr;
            ...
            "12": [
                ...
                { "../Base.js": 3, "./Numeric.js": 18, "./Type.js": 24 },
            ],
            "13": [
                function ( require, module, exports ) {
                ...
                { "../Base.js": 3, "./List.js": 15, "./Type.js": 24 },
            ],
            "14": [
                function ( require, module, exports ) {
                ...
                function ( require, module, exports ) {
                    ...
                    var List = ( function ( _Type6 ) {
                        ...
                        function List ( items, separator ) {
                            ...
                            _this10.items = items || [];
                            _this10.separator = typeof separator === "undefined"
                                ? " "
                                : separator;
                            return _this10;
                        }
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    "value": function insert ( str, startVal ) {
                                        ...
                                        inserted = inserted.slice( 0, Math.max( 0, start ) ) + str.value + inserted.slice( Math.max( 0, start ) );
            ...
            "17": [
                ...
                { "../Base.js": 3, "./List.js": 15, "./Literal.js": 16, "./Numeric.js": 18, "./Type.js": 24 },
            ],
            "18": [
                function ( require, module, exports ) {
                                ...
                                },
                                {
                                    ...
                                    "value": function numericOperate ( operation, right ) {
                                        ...
                                        if ( typeof result === "number" ) {
                                            ...
                                            return new Numeric( result, units.num.length
                                                ? units.num[ 0 ]
                                                : null, units.num, units.den );
                                        }
                ...
                { "../Base.js": 3, "./Bool.js": 8, "./Literal.js": 16, "./Type.js": 24 },
            ],
            "19": [
                function ( require, module, exports ) {
            ...
            "21": [
                ...
                { "../Base.js": 3, "../Output.js": 4, "./TypeVisitor.js": 25 },
            ],
            "22": [
                function ( require, module, exports ) {
                    "use strict";
                    ...
                    module.exports = {
                        ...
                        "boxType": function boxType ( expression ) {
                            ...
                            var typeOf = typeof expression === "undefined"
                                ? "undefined"
                                : _typeof( expression );
                            switch ( typeOf ) {
                                case "string":
                ...
                { "../Base.js": 3, "./Bool.js": 8, "./Literal.js": 16, "./Numeric.js": 18, "./Text.js": 23, "./Type.js": 24 },
            ],
            "23": [
                function ( require, module, exports ) {
            ...
            "26": [
                ...
                { "./Bool.js": 8, "./Color.js": 9, "./ColorHSLA.js": 10, "./ColorRGBA.js": 11, "./ColorStop.js": 12, "./FunctionCall.js": 13, "./LinearGradient.js": 14, "./List.js": 15, "./Literal.js": 16, "./Map.js": 17, "./Numeric.js": 18, "./ParentheticalExpression.js": 19, "./RadialGradient.js": 20, "./Text.js": 23 },
            ],
        },
        {},
        [ 1 ]
...
( function ( Fashion ) {
    ...
    Fashion.css.register(
        function ( __rt ) {
            __rt.register( {
                ...
                "mix": function ( color_1, color_2, weight ) {
                    ...
                    var factor = weight * 2 - 1,
                        ...
                        weight1 = ( ( factor * alpha == -1
                            ? factor
                            : ( factor + alpha ) / ( 1 + factor * alpha ) ) + 1 ) / 2,
                        weight2 = 1 - weight1;
            ...
            Fashion.apply( __rt.functions, {
                "material_color": function ( $color_name, $color_variant ) {
                    ...
                    __rt_set( __strings.A, __rt_box( __rt_registered.map_get.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$material_colors" ), __rt_get( __strings.$ ) ] ) ) ) );
                    if ( __rt_unbox( __rt_get( __strings.A ) ) ) {
                        __rt_set( __strings._, __rt_box( __rt.registered.map_get.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( __strings.A ), __rt_get( __strings.a ) ] ) ) ) );
                ...
                "material_foreground_color": function ( $color_name ) {
                    ...
                    var $color_name = $color_name || __Null;
                    __rt_set( __strings.$, $color_name, true );
                    __rt_set( __strings._, __rt_box( __rt.registered.map_get.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$material_foreground_colors" ), __rt_get( __strings.$ ) ] ) ) ) );
                    if ( __rt_unbox( __rt_get( __strings._ ) ) ) {
                        var $$$r = __rt_get( __strings._ );
                        __rt_popScope();
                        return $$$r;
        ...
        function ( __rt ) {
            ...
            __rt_setDynamic( "$base-color", __rt_getGlobalDefault( "$base_color" ) || __rt_box( ( __rt_functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ __rt_get( "$base_color_name" ), new __Text( "500", "'" ) ] ) ) ), 3 );
            __rt_setDynamic( "$base-highlight-color", __rt_getGlobalDefault( "$base_highlight_color" ) || __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ __rt_get( "$base_color_name" ), new __Text( "300", "'" ) ] ) ) ), 4 );
            __rt_setDynamic( "$base-light-color", __rt_getGlobalDefault( "$base_light_color" ) || __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ __rt_get( "$base_color_name" ), new __Text( "100", "'" ) ] ) ) ), 5 );
            __rt_setDynamic( "$base-dark-color", __rt_getGlobalDefault( "$base_dark_color" ) || __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ __rt_get( "$base_color_name" ), new __Text( "700", "'" ) ] ) ) ), 6 );
            __rt_setDynamic( "$base-pressed-color", __rt_getGlobalDefault( "$base_pressed_color" ) || __rt_box( __rt_registered.darken.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_test( __rt_get( "$dark_mode" ) )
                ? __rt_box( __rt.registered.darken.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$base_color" ), new __Numeric( 15, "%" ) ] ) ) )
                : __rt_box( __rt.registered.lighten.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$base_color" ), new __Numeric( 15, "%" ) ] ) ) ), new __Numeric( 0, "%" ) ] ) ) ), 7 );
            __rt_setDynamic( "$base-focused-color", __rt_getGlobalDefault( "$base_focused_color" ) || __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ __rt_get( "$base_color_name" ), new __Text( "400", "'" ) ] ) ) ), 8 );
            __rt_setDynamic( "$base-invisible-color", __rt_getGlobalDefault( "$base_invisible_color" ) || __rt_box( __rt.registered.rgba.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$base_color" ), new __Numeric( 0 ), __udf, __udf, __udf ] ) ) ), 9 );
            ...
            __rt_setDynamic( "$base-foreground-color", __rt_getGlobalDefault( "$base_foreground_color" ) || __rt_box( ( __rt.functions.material_foreground_color || material_foreground_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ __rt_get( "$base_color_name" ) ] ) ) ), 11 );
            __rt_setDynamic( "$accent_color_name", __rt_getGlobalDefault( "$accent_color_name" ) || new __Text( "orange", "'" ), 12 );
            __rt_setDynamic( "$accent-color", __rt_getGlobalDefault( "$accent_color" ) || __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ __rt_get( "$accent_color_name" ), new __Text( "500", "'" ) ] ) ) ), 13 );
            __rt_setDynamic( "$accent-light-color", __rt_getGlobalDefault( "$accent_light_color" ) || __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ __rt_get( "$accent_color_name" ), new __Text( "100", "'" ) ] ) ) ), 14 );
            __rt_setDynamic( "$accent-dark-color", __rt_getGlobalDefault( "$accent_dark_color" ) || __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ __rt_get( "$accent_color_name" ), new __Text( "700", "'" ) ] ) ) ), 15 );
            __rt_setDynamic( "$accent-pressed-color", __rt_getGlobalDefault( "$accent_pressed_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __rt_box( __rt.registered.darken.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$accent_color" ), new __Numeric( 15, "%" ) ] ) ) )
                : __rt_box( __rt.registered.lighten.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$accent_color" ), new __Numeric( 15, "%" ) ] ) ) ) ), 16 );
            __rt_setDynamic( "$accent-invisible-color", __rt_getGlobalDefault( "$accent_invisible_color" ) || __rt_box( __rt.registered.rgba.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$accent_color" ), new __Numeric( 0 ), __udf, __udf, __udf ] ) ) ), 17 );
            __rt_setDynamic( "$accent-foreground-color", __rt_getGlobalDefault( "$accent_foreground_color" ) || __rt_box( ( __rt.functions.material_foreground_color || material_foreground_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ __rt_get( "$accent_color_name" ) ] ) ) ), 18 );
            __rt_setDynamic( "$confirm-color", __rt_getGlobalDefault( "$confirm_color" ) || __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ new __Text( "light-green", "'" ), new __Text( "600", "'" ) ] ) ) ), 19 );
            __rt_setDynamic( "$confirm-pressed-color", __rt_getGlobalDefault( "$confirm_pressed_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __rt_box( __rt.registered.darken.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$confirm_color" ), new __Numeric( 15, "%" ) ] ) ) )
                : __rt_box( __rt.registered.lighten.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$confirm_color" ), new __Numeric( 15, "%" ) ] ) ) ) ), 20 );
            __rt_setDynamic( "$alert-color", __rt_getGlobalDefault( "$alert_color" ) || __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ new __Text( "red", "'" ), new __Text( "800", "'" ) ] ) ) ), 21 );
            __rt_setDynamic( "$alert-pressed-color", __rt_getGlobalDefault( "$alert_pressed_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __rt_box( __rt.registered.darken.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$alert_color" ), new __Numeric( 15, "%" ) ] ) ) )
                : __rt_box( __rt.registered.lighten.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$alert_color" ), new __Numeric( 15, "%" ) ] ) ) ) ), 22 );
            __rt_setDynamic( __strings._, __rt_getGlobalDefault( __strings._ ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __ColorRGBA.fromHex( "#fff" )
                : __ColorRGBA.fromHex( "#111111" ) ), 23 );
            __rt_setDynamic( "$reverse-color", __rt_getGlobalDefault( "$reverse_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __ColorRGBA.fromHex( "#222" )
                : __ColorRGBA.fromHex( "#fff" ) ), 24 );
            __rt_setDynamic( "$highlight-color", __rt_getGlobalDefault( "$highlight_color" ) || __rt_box( __rt.registered.rgba.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( __strings._ ), new __Numeric( 0.54 ), __udf, __udf, __udf ] ) ) ), 25 );
            __rt_setDynamic( "$disabled-color", __rt_getGlobalDefault( "$disabled_color" ) || __rt_box( __rt.registered.rgba.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( __strings._ ), new __Numeric( 0.38 ), __udf, __udf, __udf ] ) ) ), 26 );
            __rt_setDynamic( "$reverse-disabled-color", __rt_getGlobalDefault( "$reverse_disabled_color" ) || __rt_box( __rt.registered.rgba.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( "$reverse_color" ), new __Numeric( 0.38 ), __udf, __udf, __udf ] ) ) ), 27 );
            __rt_setDynamic( "$divider-color", __rt_getGlobalDefault( "$divider_color" ) || __rt_box( __rt.registered.mix.apply( __rt.registered, __rt_applySpreadArgs( [ __rt_get( __strings._ ), __rt_get( "$reverse_color" ), new __Numeric( 12, "%" ) ] ) ) ), 28 );
            __rt_setDynamic( "$selected-background-color", __rt_getGlobalDefault( "$selected_background_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __rt_get( "$base_dark_color" )
                : __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ new __Text( "grey", "'" ), new __Text( "300", "'" ) ] ) ) ) ), 29 );
            __rt_setDynamic( "$hovered-background-color", __rt_getGlobalDefault( "$hovered_background_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __ColorRGBA.fromHex( "#4d4d4d" )
                : __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ new __Text( "grey", "'" ), new __Text( "200", "'" ) ] ) ) ) ), 30 );
            __rt_setDynamic( "$header-background-color", __rt_getGlobalDefault( "$header_background_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ new __Text( "grey", "'" ), new __Text( "800", "'" ) ] ) ) )
                : __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [ new __Text( "grey", "'" ), new __Text( "100", "'" ) ] ) ) ) ), 31 );
            __rt_setDynamic( "$faded-color", __rt_getGlobalDefault( "$faded_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __ColorRGBA.fromHex( "#4d4d4d" )
                : __ColorRGBA.fromHex( "#e1e1e1" ) ), 32 );
            __rt_setDynamic( "$background-color", __rt_getGlobalDefault( "$background_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __ColorRGBA.fromHex( "#303030" )
                : __ColorRGBA.fromHex( "#fafafa" ) ), 33 );
            __rt_setDynamic( "$alt-background-color", __rt_getGlobalDefault( "$alt_background_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __ColorRGBA.fromHex( "#3a3a3a" )
                : __ColorRGBA.fromHex( "#f5f5f5" ) ), 34 );
            __rt_setDynamic( "$reverse-background-color", __rt_getGlobalDefault( "$reverse_background_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __ColorRGBA.fromHex( "#fafafa" )
                : __ColorRGBA.fromHex( "#303030" ) ), 35 );
            __rt_setDynamic( "$reverse-alt-background-color", __rt_getGlobalDefault( "$reverse_alt_background_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __ColorRGBA.fromHex( "#f5f5f5" )
                : __ColorRGBA.fromHex( "#3a3a3a" ) ), 36 );
            __rt_setDynamic( "$overlay-color", __rt_getGlobalDefault( "$overlay_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __rt_box( __rt.registered.rgba.apply( __rt.registered, __rt_applySpreadArgs( [ __ColorRGBA.fromHex( "#fff" ), new __Numeric( 0.03 ), __udf, __udf, __udf ] ) ) )
                : __rt_box( __rt.registered.rgba.apply( __rt.registered, __rt_applySpreadArgs( [ __ColorRGBA.fromHex( "#000" ), new __Numeric( 0.03 ), __udf, __udf, __udf ] ) ) ) ), 37 );
            ...
            __rt_setDynamic( "$reverse-border-color", __rt_getGlobalDefault( "$reverse_border_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __ColorRGBA.fromHex( "#212121" )
                : __ColorRGBA.fromHex( "#e0e0e0" ) ), 42 );
            __rt_setDynamic( "$reverse-alt-border-color", __rt_getGlobalDefault( "$reverse_alt_border_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __ColorRGBA.fromHex( "#3a3a3a" )
                : __ColorRGBA.fromHex( "#e0e0e0" ) ), 43 );
        },
        {
            ":root": [ "dark-mode", "base-color", "base-highlight-color", "base-light-color", "base-dark-color", "base-pressed-color", "base-focused-color", "base-invisible-color", "base-foreground-color", "accent-color", "accent-light-color", "accent-dark-color", "accent-pressed-color", "accent-invisible-color", "accent-foreground-color", "confirm-color", "confirm-pressed-color", "alert-color", "alert-pressed-color", __names._, "reverse-color", "highlight-color", "disabled-color", "reverse-disabled-color", "divider-color", "selected-background-color", "hovered-background-color", "header-background-color", "faded-color", "background-color", "alt-background-color", "reverse-background-color", "reverse-alt-background-color", "overlay-color", "content-padding", "listitem-selected-background-color", "reverse-border-color", "reverse-alt-border-color" ],
            "html": [ "base_color_name", "accent_color_name", "dataview_item_selected_background_color", "dataitem_selected_background_color" ],
        }
    );
} )( Fashion );
